		...
		<div class="list">
			...
			<table style="width: 700px;">
				...
				<tbody>
					...
					<tr>
						<td>상호</td>
						<td><input type="text" readonly="readonly" value="${userSession.comp_name}" style="width: 250px;" /></td>
					</tr>	
					<tr>
						<td>사업자 주소</td>
						<td><input type="text" readonly="readonly" value="${userSession.comp_add}" style="width: 250px;" /></td>
					</tr>
					<tr>
						<td>사업자 전화번호</td> 
						<td><input type="text" id="user_tel" name="user_tel" readonly="readonly" value="${userSession.user_tel}" style="width: 250px;" /></td>
					</tr>
					<tr>
				</tr>
				</tbody>
...
<!-- pro_contents2.jsp end -->
		...
		<input type="button" id="ins_promo_btn" value="작성완료" style="font-size: 15px; float: right;" />
	</section>
<!-- hoswrite.jsp end -->
		</div>
	</div>
...
<script type="text/javascript" src="./resources/js/reservation/promo_write.js"></script>
</html>