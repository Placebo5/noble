...
// 						alert(document.getElementsByName("holiday")[i].checked);
		...
		var cnts2 = CKEDITOR.instances.pro_contents2;
		if(cnts2.getData() == ""){
			alert("내용을 확인 하세요.");
			cnts2.focus();
			return;
		...
		form.append('pro_contents2',cnts2.getData());
